...
PORT (
      ...
      dout                            : OUT std_logic_vector(7 DOWNTO 0);
      dout_valid                      : OUT std_logic;
      dut_din                         : OUT std_logic_vector(95 DOWNTO 0);
...
COMPONENT fcc_fixpt_wrapper IS 
PORT (
      clk                             : IN  std_logic;
      enb                             : IN  std_logic;
      reset                           : IN  std_logic;
...
END COMPONENT;
  ...
  SIGNAL dut_din                          : std_logic_vector(95 DOWNTO 0); -- std96
